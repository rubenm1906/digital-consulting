...
const translations = {
    ...
    en: {
        ...
        "what-we-do-list": "<li><span class='icon'>💻</span> We design customized technological solutions to digitize processes and improve efficiency.</li><li><span class='icon'>🤖</span> We implement artificial intelligence and automation to optimize costs and performance.</li><li><span class='icon'>🔗</span> We enhance integration between digital tools to maximize their impact on your business.</li>",
